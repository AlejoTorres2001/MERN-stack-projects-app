...
const ProfilePicModal = ({isOpen,close}) => {
    ...
    const handleChange = (e) => {
		...
		if(!isValidSize) return toast.error("Your iamge is too Heavy, max size 20MB")
        ...
        <Modal show={isOpen} onHide={close}>
            ...
            <Modal.Body>
                ...
                <Form.Label>Upload your Picture</Form.Label>
                   <Form.Control type="file" accept=".jpg, .jpeg, .gif, .png" onChange={handleChange}>
            ...
            <Modal.Footer>
                ...
                <Button variant="primary" onClick={handleUpdateProfilePic}>Select Image</Button>
            </Modal.Footer>
        </Modal>
    )
}
