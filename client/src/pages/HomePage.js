    ...
    return (
       <Container>
           <Row className="mt-5">
               ...
               <p>Tick your tasks as finished,add new ones, delete them or update previous tasks</p>
               </Col>
               <div>
                   <Button className="ms-1" as={Link} to={routes.register}>Sign-in</Button> or <Link to={routes.login}>Log-in</Link> 
               </div>
               <Col>
